...
class ChannelListUpdateMenu(Screen):
	...
	def versionInfoCallBackQuiet(self, html):
		content = html.decode('utf-8') if isinstance(html, bytes) else str(html)
...
class ChannelListUpdateUpdater(Screen):
	...
	def downloadFinished(self, string = ''):
		if self.md5 and self.md5 != "00000000000000000000000000000000" and self.md5 != "000000000000000000000000":
			calculated_md5 = hashlib.md5(open(self.dlfile, 'rb').read()).hexdigest()
