...
class ChannelListUpdateMenu(Screen):
	...
	def updateList(self):
		...
		mypixmap = os.path.join(mypath, "hswg.png")
		...
		mypixmap = os.path.join(mypath, "djcrash.png")
		png = LoadPixmap(mypixmap)
		...
		mypixmap = os.path.join(mypath, "k80.png")
		png = LoadPixmap(mypixmap)
		...
		mypixmap = os.path.join(mypath, "fk.png")
		png = LoadPixmap(mypixmap)
		...
		mypixmap = os.path.join(mypath, "ms.png")
		png = LoadPixmap(mypixmap)
		...
		mypixmap = os.path.join(mypath, "seto.png")
		png = LoadPixmap(mypixmap)
		...
		mypixmap = os.path.join(mypath, "picon.png")
		png = LoadPixmap(mypixmap)
	...
	def versionInfoCallBack(self, html, verbose=True):
		...
		if config.has_section("plugin"):
			...
			# Fallback if configparser fails
...
class ChannelListUpdateUpdater(Screen):
	...
	def downloadFinished(self, string = ''):
		...
		try:
			...
			print(e)
			self['status'].setText(_('Błąd instalacji!'))
			return
