...
class ChannelListUpdateMenu(Screen):
	...
	def __init__(self, session):
		...
		self.newFile = ""
		self.fileUrl = ""
		self.MD5 = "00000000000000000000000000000000"
	...
	def downloadFinished(self, string = ''):
		if self.md5 and self.md5 != "00000000000000000000000000000000":
			with open(self.dlfile, "rb") as f:
				data = f.read()
				md5_calc = hashlib.md5(data).hexdigest()
				if md5_calc != self.md5:
					self['status'].setText(_('Błąd MD5! Pobrany plik jest uszkodzony.'))
					return
