...
class ChannelListUpdateMenu(Screen):
	...
	def versionInfoCallBackQuiet(self, html):
		...
		if self.fileUrl and self.newFile:
			self.updateurl = self.fileUrl + ("" if self.fileUrl.endswith("/") else "/") + self.newFile
		else:
			self.updateurl = ""
...
class HSWG(CommonChannelListScreen):
	def __init__(self, session, args = None):
		...
		self.url1 = 'https://raw.githubusercontent.com/fullkiller/Rango_channel_list/main/latest3x.txt'
		self.url2 = 'https://raw.githubusercontent.com/fullkiller/Rango_channel_list/main/latest4x.txt'
...
class Fk(CommonChannelListScreen):
	def __init__(self, session, args = None):
		...
		self.url1 = 'https://raw.githubusercontent.com/fullkiller/Rango_channel_list/main/latest1x.txt'
...
class Seto(CommonChannelListScreen):
	def __init__(self, session, args = None):
		...
		self.url1 = 'https://raw.githubusercontent.com/fullkiller/Rango_channel_list/main/latest7x.txt'
...
class ChannelListUpdateUpdater(Screen):
	...
	def downloadFinished(self, string = ''):
		...
		if not error:
			...
			self.session.open(MessageBox, _('Błąd podczas instalowania aktualizacji!'), MessageBox.TYPE_ERROR)
