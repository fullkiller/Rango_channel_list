...
import traceback
import re, os, tarfile, zipfile, shutil, glob, hashlib, io
try:
	import configparser
except ImportError:
...
def safe_tar_extract(src, dest, **kwargs):
	...
	with tarfile.open(src, 'r:gz') as tar:
		...
		safe_extract(tar, dest, numeric_owner=numeric_owner)
...
class CommonChannelListScreen(Screen):
	skin = """
		<screen position="center,center" size="1150,340" >
			...
			<widget name="sats3x" 		position="900,90" size="290,25" font="Regular;18" halign="left" />
