...
def is_path_safe(base, target):
	...
	if base == '/':
		# When base is root, any path starting with / is inside it.
		# But we usually want to prevent escaping if base was something else.
		# For root, it's a bit special.
		return target.startswith(os.sep)
	return os.path.commonprefix([base, target]) == base

def safe_tar_extract(tar_file, path=".", **kwargs):
...
class CommonChannelListScreen(Screen):
	skin = """
		<screen position="center,center" size="1150,340" >
			...
			<widget name="sats3" 		position="900,90" size="290,25" font="Regular;18" halign="left" />
			...
			<widget name="newVersion3x" 	position="900,150" size="290,25" font="Regular;18" halign="left" />
	...
	def downloadCallBack(self, html, plik = "/tmp/chList1x1.tgz"):
		try:
			...
			for f in ('lamedb', 'satellites.xml', 'whitelist', 'blacklist', 'revision'):
				if os.path.exists('/etc/enigma2/' + f): os.remove('/etc/enigma2/' + f)
...
class Djcrash(Screen):
	skin = """
		<screen position="center,center" size="1150,340" >
			<widget name="typ" 		position="30,10" size="130,40" font="Regular;32" halign="left" />
			<widget name="typ0" 		position="230,10" size="100,40" font="Regular;32" halign="left" />
			<widget name="typ1"		position="455,10" size="100,40" font="Regular;32" halign="left" />
			<widget name="typ2"		position="675,10" size="100,40" font="Regular;32" halign="left" />
			<widget name="typ3"		position="900,10" size="100,40" font="Regular;32" halign="left" />
			<widget name="sats0" 		position="30,70" size="190,25" font="Regular;18" halign="left" />
			<widget name="new0" 		position="30,170" size="190,25" font="Regular;18" halign="left" />
			<eLabel 			position="5,60" size="1140,2" font="Regular;18" halign="center" backgroundColor="white" />
			<widget name="sats1x" 		position="230,70" size="180,25" font="Regular;18" halign="left" />
			<widget name="newVersion1x" 	position="230,170" size="180,25" font="Regular;18" halign="left" />
			<eLabel 			position="220,63" size="2,135" font="Regular;18" halign="center" backgroundColor="white" />
			<widget name="sats2x" 		position="455,70" size="200,75" font="Regular;18" halign="left" />
			<widget name="newVersion2x" 	position="455,170" size="200,25" font="Regular;18" halign="left" />
			<eLabel 			position="445,63" size="2,135" font="Regular;18" halign="center" backgroundColor="white" />
			<eLabel 			position="665,63" size="2,135" font="Regular;18" halign="center" backgroundColor="white" />
			<widget name="sats4x" 		position="675,70" size="180,70" font="Regular;18" halign="left" />
			<widget name="newVersion4x" 	position="675,170" size="200,25" font="Regular;18" halign="left" />
			<eLabel 			position="890,63" size="2,135" font="Regular;18" halign="center" backgroundColor="white" />
			<widget name="sats20x" 		position="900,70" size="240,100" font="Regular;18" halign="left" />
			<widget name="newVersion20x" 	position="900,170" size="240,25" font="Regular;18" halign="left" />
			<eLabel 			position="1145,63" size="2,135" font="Regular;18" halign="center" backgroundColor="white" />
			<eLabel 			position="5,63" size="2,135" font="Regular;18" halign="center" backgroundColor="white" />
			<eLabel 			position="5,200" size="1140,2" font="Regular;18" halign="center" backgroundColor="white" />
			...
			<widget name="key_blue"		position="875,230" size="265,40" font="Regular;24" halign="center" valign="center" backgroundColor="blue" />
			<widget name="status"		position="5,300" size="1140,40" font="Regular;24" halign="center" valign="center" backgroundColor="blue" />
		</screen>"""
	...
	def downloadFromUpload(self):
		...
		downloadPage("http://upload.sat-elita.net.pl/download.php?id=" + self.chID, '/tmp/lista.zip').addCallback(self.installChList).addErrback(self.downloadFromPKT)
