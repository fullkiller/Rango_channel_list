...
def is_path_safe(base, target):
	...
	if target == base:
		return True
	return target.startswith(base + os.path.sep) or base == "/"
		...
		if os.path.exists('/proc/mounts'):
			with open('/proc/mounts', 'r') as f:
				for line in f:
					if '/media/cf' in line:
						mycf = '/media/cf/'
					elif '/media/usb' in line and not '/media/usb2' in line and not '/media/usb3' in line:
						myusb = '/media/usb/'
						...
						mysd = '/media/card/'
					elif '/hdd' in line and not '/hdd2' in line:
						myhdd = '/media/hdd/'
					elif '/hdd2' in line:
						myhdd2 = '/media/hdd2/'
